...
class writeexcel_workbook extends writeexcel_biffwriter
{
     ...
     */
    public function &addformat($para = false)
    {
        if ($para === false) {
     ...
     */
    public function set_1904($_1904)
    {
        $this->_1904 = $_1904;
    }
     ...
     */
    public function set_custom_color($index, $red, $green, $blue)
    {
        // todo
        /*
     ...
     */
    public function set_palette_xl97()
    {
        $this->_palette = array(
     ...
     */
    public function set_palette_xl5()
    {
        $this->_palette = array(
            array(0x00, 0x00, 0x00, 0x00), # 8
            array(0xff, 0xff, 0xff, 0x00), # 9
     ...
     * storage.
     */
    public function _store_workbook()
    {
     ...
     */
    public function _store_all_fonts()
    {
     ...
     */
    public function _store_all_num_formats()
    {
     ...
     */
    public function _store_all_xfs()
    {
        # _tmp_format is added by new(). We use this to write the default XF's
     ...
     */
    public function _store_all_styles()
    {
        $this->_store_style();
    }
     ...
     * the NAME records.
     */
    public function _store_externs()
    {
     ...
     */
    public function _store_window1()
    {
     ...
     */
    public function _store_boundsheet($sheetname, $offset)
    {
     ...
     */
    public function _store_num_format($num_format, $index)
    {
     ...
     */
    public function _store_externcount($par0)
    {
     ...
     * A similar method is used in Worksheet.pm for a slightly different purpose.
     */
    public function _store_externsheet($par0)
    {
     ...
     */
    public function _store_name_short($par0, $par1, $par2, $par3, $par4, $par5)
    {
     ...
     */
    public function _store_name_long($par0, $par1, $par2, $par3, $par4, $par5)
    {
        $record = 0x0018;    # Record identifier
     ...
     */
    public function _store_palette()
    {
        $aref = &$this->_palette;
     ...
     */
    public function _store_codepage()
    {
