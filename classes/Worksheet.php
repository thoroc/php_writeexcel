...
class Worksheet extends BIFFWriter
{
    ...
    function Worksheet( $name, $index, &$activesheet, &$firstsheet, &$url_format, &$parser, $tempdir )
    {
...
#
    ...
    function write_url()
    {
        ...
        return call_user_func_array( array( &$this, 'write_url_range' ), array_merge( array(
            $_[0], $_[1] ), $_ ) );
    }
###############################################################################
#
